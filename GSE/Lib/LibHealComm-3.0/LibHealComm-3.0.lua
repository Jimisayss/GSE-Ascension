-- Use a high minor version so this stub supersedes packaged copies
-- such as the one shipped in standalone Ace3 distributions.
local MAJOR, MINOR = "LibHealComm-3.0", 90000
...
-- Expose globally so diagnostics and other addons can find it
LibHealComm = lib
